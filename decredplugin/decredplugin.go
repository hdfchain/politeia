...
type Comment struct {
	...
	// Metadata generated by hdfchain plugin
...
// NewCommentReply returns the metadata generated by hdfchain plugin for the new
// comment.
...
// Inventory is used to retrieve the hdfchain plugin inventory for all versions
// of the provided record tokens. If no tokens are provided, the hdfchain plugin
...
// InventoryReply returns the hdfchain plugin inventory.
